    ...
    <div className="card space-y-3 border-accent/30">
      <div>
        ...
        <p className="text-xs text-black/60">
          Add students, update phone/email, sync course completions, newsletter/Groupme flags, or apply bulk updates. Review merge targets and field changes before committing.
        </p>
      </div>
      ...
      {viewState === "input" ? (
        <div className="space-y-3">
          <textarea
            ...
            placeholder={`e.g. "Add Grace" or "Caleb - 555-123-4567, caleb@example.com" or "Mark newsletter for: Rip, Katie"`}
          />
